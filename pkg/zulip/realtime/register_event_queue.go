...
const (
	...
	EmptyTopicName             ClientCapability = "empty_topic_name"
	SimplifiedPresenceEvents   ClientCapability = "simplified_presence_events"
)
...
func (svc *Service) RegisterEventQueue(ctx context.Context, options ...RegisterEventQueueOption) (*RegisterEventQueueResponse, error) {
	const (
